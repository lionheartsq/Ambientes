...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-09-2016 a las 02:36:06
...
INSERT INTO `ambiente` (`ID_AMBIENTE`, `ID_CENTRO`, `CODIGO`, `NOMBRE`, `DESCRIPCION`, `PUESTOS_TRABAJO`) VALUES
(1, 1, 1, 'Prueba', 'Ambiente', 30);
...
INSERT INTO `centro_formacion` (`ID_CENTRO`, `CODIGO`, `ID_REGIONAL`, `DESCRIPCION`) VALUES
(1, 1, 1, 'CIDM'),
(3, 2, 1, 'CASA'),
(4, 3, 1, 'CIMI');
...
CREATE TABLE `ficha` (
  ...
  `INSTRUCTOR_LIDER` varchar(250) DEFAULT NULL,
...
INSERT INTO `ficha` (`ID_FICHA`, `ID_NIVEL`, `CODIGO`, `PROGRAMA`, `INSTRUCTOR_LIDER`, `FECHA_INICIO_LECTIVA`, `FECHA_FIN_LECTIVA`, `FECHA_CIERRE_FICHA`) VALUES
(111, 1, 1, 'prueba', 'prueba', '2016-04-13', '2016-12-13', '2018-12-13');
...
INSERT INTO `nivel_formacion` (`ID_NIVEL`, `DESCRIPCION`) VALUES
(1, 'Tecnico'),
(2, 'Tecnólogo');
...
CREATE TABLE `notificaciones` (
  ...
  `ESTADO` enum('Permiso','Reemplazo','Incapacidad','T. Externo') DEFAULT NULL,
  `DESCRIPCION` varchar(500) DEFAULT NULL,
...
INSERT INTO `regional` (`ID_REGIONAL`, `CODIGO`, `DESCRIPCION`) VALUES
(1, 1, 'Santander'),
(2, 2, 'Cundinamarca');
...
CREATE TABLE `solicitud` (
  ...
  `HORA_INICIO` time DEFAULT NULL,
  `HORA_FIN` time DEFAULT NULL,
  `ESTADO` enum('Respondida','Espera','','') DEFAULT NULL,
...
INSERT INTO `solicitud` (`ID_SOLICITUD`, `ID_AMBIENTE`, `FECHA_SOLICITUD`, `FECHA_RESPUESTA`, `FECHA_INICIO`, `FECHA_FIN`, `HORA_INICIO`, `HORA_FIN`, `ESTADO`, `NUMERO_PERSONAS`, `ID_USUARIO`) VALUES
(1, 1, '2016-07-09', NULL, '2016-07-10', '2016-07-13', '06:00:00', '18:00:00', NULL, 25, NULL);
...
(1, 'lucho', 'lucho', 'lucho@mail.com', 'lucho@mail.com', 1, 'tpg1zowq1c0wsgko08ssc04oo4gkc8g', '$2y$13$tpg1zowq1c0wsgko08sscuc9yYv2lCQpCGInJJDxnjT.QBV7r7Rau', '2016-09-12 00:35:45', 0, 0, NULL, NULL, NULL, 'a:2:{i:0;s:11:"SUPER_ADMIN";i:1;s:16:"ROLE_SUPER_ADMIN";}', 0, NULL),
(2, 'usuario', 'usuario', 'us@us.co', 'us@us.co', 1, '60zy01idiko4wkc8o4kw8ssoosw4w4k', '$2y$13$60zy01idiko4wkc8o4kw8ewNRJIWwxOZdjj2WqxEi0OOlqcg1uiAO', '2016-09-12 02:14:53', 0, 0, NULL, NULL, NULL, 'a:0:{}', 0, NULL);
...
INSERT INTO `usuario` (`ID_USUARIO`, `ID_ESTADO_USUARIO`, `ID_TIPO_USUARIO`, `CEDULA`, `NOMBRE`, `TELEFONO`, `TAG`, `EMAIL`, `FOTO`) VALUES
(146, 2, 6, 123, 'Prueba', 123, NULL, 'a@a.a', NULL);
...
--
ALTER TABLE `ficha`
  MODIFY `ID_FICHA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
--
...
--
ALTER TABLE `regional`
  MODIFY `ID_REGIONAL` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
